...
public class TPEditor {
    ...
    public TPEditor() {
        ...
        jFrame = new JFrame("Editor_Grupo5 - Sin Título");
   ...
   //     jTextArea.setWrapStyleWord(true);
    ...
    private void buildMenuBar() {
        ...
        JMenuItem itemReplace = new JMenuItem("Remplazar");
        itemReplace.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R, ActionEvent.CTRL_MASK));
        itemReplace.setActionCommand("cmd_replace");
        ...
        //contruye el boton de grafica DOM
        JMenu menuGrafic = new JMenu("Grafica");
 
        JMenuItem itemGrafic = new JMenuItem("Arbol DOM");
        itemGrafic.setActionCommand("cmd_arbol");
 
        menuGrafic.add(itemGrafic);
        ...
        jMenuBar.add(Box.createHorizontalStrut(5));
        jMenuBar.add(menuGrafic);
        jMenuBar.add(Box.createHorizontalStrut(5));
        //jMenuBar.add(menuRun);
       // jMenuBar.add(Box.createHorizontalStrut(5));
    ...
    class EventHandler extends MouseAdapter implements ActionListener,
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            } else if (ac.equals("cmd_replace") == true) {    //opción seleccionada: "Remplazar"
                actionPerformer.actionReplace();
