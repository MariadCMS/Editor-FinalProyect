...
public class ActionPerformer {
    ...
    public void actionOpen() {
        ...
        if (state == JFileChooser.APPROVE_OPTION) {    //si elige abrir el archivo
            ...
            try {
                ...
                tpEditor.getJFrame().setTitle("Abrir - " + f.getName());
    ...
    public void actionSaveAs() {
        ...
        if (state == JFileChooser.APPROVE_OPTION) {    //si elige guardar en el archivo
            ...
            try {
                ...
                tpEditor.getJFrame().setTitle("Guardar como... - " + f.getName());
     ...
     * 
     * Busca el texto de la última la palabra selecionada y remplaza por la especificada por el ususario.
     */
    ...
    /**
     * Opción seleccionada: "Arbol DOM".
     * 
     * Le permite al usuario visualizar el DOM.
     */
    ...
    private static JFileChooser getJFileChooser() {
        ...
        fc.setDialogTitle("Elige un archivo:");                   //se le establece un título
